...
const ROUTES = [
  ...
  ['GET', '/api/training/venue-unavailability', 'auth'],
  ...
  ['POST', '/api/training/defaults/publish', 'auth'],
  ['POST', '/api/training/defaults/discard-draft', 'auth'],
  ...
  ['POST', '/api/training/auto-schedule', 'auth'],
